...
def download_template():
    ...
    sample_row = {
        ...
        "G2(second period grade)(0-20)"         : 9,
        "absences(0-93)"   : 5,
        "failures(1-4)"   : 0,
        "studytime(1-4)"  : 2,
        "traveltime(1-4)" : 1,
        "family relationships(1-5)"     : 4,
        "freetime(1-5)"   : 3,
        "goout(1-5)"      : 3,
        "workday alcohol consumption(1-5)"       : 1,
        "weekend alcohol consumption(1-5)"       : 2,
        "health(1-5)"     : 4,
        "mother's education(0-4)"       : 3,
        "father's education(0-4)"       : 2,
        "extra educational support(0/1)"  : 0,
        "family educational support(0/1)"     : 1,
        "extra paid classes(0/1)"       : 0,
