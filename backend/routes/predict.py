...
from auth                import get_current_user
from database            import User
import model_loader                          # import module not values
...
def download_template():
    ...
    Includes:
      ...
      Row 2 : range/description guide (prefix NOTE:) — delete before uploading
      Row 3 : example student data
    """
    # Row 2 — range guide so faculty know what values to enter
    range_guide = {
        "student_id" : "NOTE: any unique ID",
        "G1"         : "NOTE: 0-20",
        "G2"         : "NOTE: 0-20",
        "absences"   : "NOTE: 0-93",
        "failures"   : "NOTE: 0=none 1=one 2=two 3=three+",
        "studytime"  : "NOTE: 1=<2hrs 2=2-5hrs 3=5-10hrs 4=>10hrs",
        "traveltime" : "NOTE: 1=<15min 2=15-30min 3=30-60min 4=>1hr",
        "famrel"     : "NOTE: 1=very bad 2=poor 3=avg 4=good 5=excellent",
        "freetime"   : "NOTE: 1=very low 2=low 3=moderate 4=high 5=very high",
        "goout"      : "NOTE: 1=very rarely 2=rarely 3=sometimes 4=often 5=very often",
        "Dalc"       : "NOTE: 1=never 2=rarely 3=sometimes 4=often 5=very often",
        "Walc"       : "NOTE: 1=never 2=rarely 3=sometimes 4=often 5=very often",
        "health"     : "NOTE: 1=very poor 2=poor 3=fair 4=good 5=very good",
        "Medu"       : "NOTE: 0=none 1=primary 2=middle 3=secondary 4=higher",
        "Fedu"       : "NOTE: 0=none 1=primary 2=middle 3=secondary 4=higher",
        "schoolsup"  : "NOTE: 0=no 1=yes",
        "famsup"     : "NOTE: 0=no 1=yes",
        "paid"       : "NOTE: 0=no 1=yes",
        "activities" : "NOTE: 0=no 1=yes",
        "higher"     : "NOTE: 0=no 1=yes",
        "internet"   : "NOTE: 0=no 1=yes",
        "romantic"   : "NOTE: 0=no 1=yes",
    }

    # Row 3 — example student
    sample_row = {
        "student_id" : "STU-001",
        "G1"         : 10,
        "G2"         : 9,
    ...
    df  = pd.DataFrame([range_guide, sample_row])
    buf = io.StringIO()
    df.to_csv(buf, index=False)
    buf.seek(0)
...
def predict_single(
    ...
    try:
        model_loader.load_models()   # no-op if already loaded
        result = run_full_assessment(
            student_id   = payload.student_id,
            student_data = student_data,
            model        = model_loader.MODEL,
...
def predict_batch(
    ...
    for idx, row in df.iterrows():
        ...
        # Skip the range guide row (row with NOTE: prefix)
        if str(sid).startswith("NOTE:"):
            continue
